...
class ATM90E36 {
 private:
  int _energy_CS;
  unsigned short CommEnergyIC(unsigned char RW, unsigned short address,
                              unsigned short val);
 ...
 public:
  ...
  void begin();
  void begin_simple();
  void calibrate(unsigned int Ugaina, unsigned int Ugainb, unsigned int Ugainc,
                 unsigned int Igaina, unsigned int Igainb, unsigned int Igainc,
                 unsigned int mMode0);
  void calibrateNew(unsigned int Ugaina, unsigned int Ugainb,
  ...
  */
  ...
  void isVoltageSag(uint16_t* value);
  void isPhaseLoss(uint16_t* value);
  bool isVoltagePhaseSequenceError();
  bool isCurrentPhaseSequenceError();
